(function () {
  ...
  ***************************************************************************** */
        ...
        if (updateFrom !== undefined) {
          ...
          yield(yield updateFrom.previouslyCachedResources())
            ...
            .reduce((previous, url) => __awaiter(this, void 0, void 0, function* () {
              ...
              yield metaTable.write(req.url, Object.assign(Object.assign({}, res.metadata), {
                used: false
              }));
            }), Promise.resolve());
        }
  ...
  class DataGroup {
    ...
    clearCacheForUrl(url) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all([
          cache.delete(this.adapter.newRequest(url, {
            method: 'GET'
   ...
   * found in the LICENSE file at https://angular.io/license
   */
  const SW_VERSION = '13.0.0-next.0';
    ...
    reportStatus(client, promise, nonce) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          client.postMessage(Object.assign(Object.assign({}, response), {
            status: false,
            error: e.toString()
          }));
        }
